  ...
  pages: {
    ...
    privacyPolicy: {
      ...
      body: [
        ...
        { p: 'We share information with third-party service providers who help us operate the site and run our business. These providers are contractually obligated to use your information only as necessary to provide services to us. The providers we currently use are: Vercel (website hosting and serverless functions, which processes request metadata including IP addresses), Vercel Postgres (database storage for form submissions), Resend (delivery of transactional email such as your enquiry or a requested report), and, with your consent only, Google Tag Manager, Google Analytics and the Meta Pixel for analytics.' },
        { p: 'Some of these providers process data on servers outside India. Where that happens, the transfer is limited to what is needed to deliver the service described above.' },
        { h: '7. Your Rights' },
        ...
        { h: '10. Data Retention' },
        { p: 'We keep the information you submit for as long as we need it for the purpose you gave it to us, and to meet our legal and record-keeping obligations. Contact enquiries and consultation requests are kept while your relationship with us is active and for a reasonable period afterwards. Newsletter and community signups are kept until you unsubscribe. Corporate enquiries, including workplace readiness assessments and resource downloads, are kept while the enquiry is open and for a reasonable period afterwards.' },
        { p: 'When you submit a form we also record the IP address the submission came from. We use it only to detect and limit spam and abuse, and we do not use it to identify you or build a profile.' },
        { p: 'You can ask us to delete information we hold about you at any time using the contact details below, subject to any legal obligation we have to retain it.' },
